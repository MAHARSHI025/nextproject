...
function page() {
  return (
    <>
      ...
      <h1 className=" text-center font-semibold text-3xl mt-10">What I do ?</h1>

      <Linear></Linear>
      <h1 className=" text-center font-semibold text-3xl my-10">PRICING</h1>
      <div className=' flex flex-wrap justify-evenly'>
        <div className="card flex flex-col flex-nowrap">
          ...
          <div className="textarea flex flex-col flex-nowrap">
            <h1 className=" text-center font-semibold text-2xl">BASIC</h1>
        ...
        <div className="card extra">
          ...
          <div className="textarea flex flex-col">
            <h1 className="diff text-center font-semibold text-2xl">STANDARD</h1>
        ...
        <div className="card">
          ...
          <div className="textarea flex flex-col">
            <h1 className=" text-center font-semibold text-2xl">PREMIUM</h1>
