    ...
    return (
        <>
            <div className="follow" id='follow'>
                <h1 className=" text-center font-semibold text-3xl mt-10 mb-6 noto marger">CONTACT ME</h1>
                <div className="section flex flex-wrap flex-row justify-center items-center">
                    <div className="lootie">
                        <script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script>
                        <dotlottie-player src="https://lottie.host/93f5c350-753f-4cf8-841e-a82d046c4867/acpw1T7v7V.json" background="transparent" speed="3" direction="1" playMode="normal" loop autoplay></dotlottie-player>
                    </div>
